// Stolen from:
// https://github.com/ppy/osu-framework/blob/master/osu.Framework/Platform/IconGroup.cs
...
namespace Pellychan.GUI.Framework.Platform;

internal class IconGroup
{
    [SupportedOSPlatform("windows")]
    [DllImport("user32.dll")]
    private static extern nint CreateIconFromResourceEx(byte[] pbIconBits, uint cbIconBits, bool fIcon, uint dwVersion, int cxDesired, int cyDesired, uint uFlags);
